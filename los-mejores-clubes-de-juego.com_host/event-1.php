...
<head>
  ...
  <meta property="og:title" content="Nuevo sports bar en mexico con pantallas gigantes y buena comida. Final de la liga de campeones. ciudad de manchester - inter">
  ...
  <meta name="twitter:title" content="Nuevo sports bar en mexico con pantallas gigantes y buena comida. Final de la liga de campeones. ciudad de manchester - inter">
  ...
  <meta name="description"
    content="Sports Bar con la mejor gastronomía y las retransmisiones deportivas de mayor audiencia cualquier día de la semana. Tocamos música diferente, organizamos veladas temáticas y concursos.">
  <title>Nuevo sports bar en mexico con pantallas gigantes y buena comida. Final de la liga de campeones. ciudad de manchester - inter</title>
      ...
      <div class="evnt-item">
          ...
          <ul class="evnt-item__images">
            <li class="evnt-item__image evnt-item__image_1">
              <picture>
                ...
                <img src="./img/event/event-1.jpg" loading="lazy" width="300" height="300" alt="Image">
              </picture>
            </li>
            <li class="evnt-item__image evnt-item__image_2">
              <picture>
                <source media="(min-width: 320px)" srcset="./img/event/event-1-1.webp" type="image/webp"> 
                <img src="./img/event/event-1-1.jpg" loading="lazy" width="300" height="300" alt="Image">
              </picture>
            </li>
          </ul>
        ...
        <div class="evnt-item__bottom">
          <div class="evnt-item__image evnt-item__image_3">
            <picture>
            <source media="(min-width: 1024px)" srcset="./img/event/event-1-2.webp" type="image/webp"> 
            <img src="./img/event/event-1-2.jpg" loading="lazy" width="300" height="300" alt="Image">
            </picture>
          </div>
