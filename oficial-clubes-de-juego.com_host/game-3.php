...
<head>
  ...
  <meta property="og:title"
    content="Juego de acción con un mundo abierto y una nueva historia. Juego disponible en PS5. Dead Space">
  ...
  <meta name="description"
    content="El juego ofrece gráficos mejorados y un tema musical pegadizo. El juego tendrá una mecánica de combate reelaborada y nuevas características con efectos especiales mejorados.">
  <title>Juego de acción con un mundo abierto y una nueva historia. Juego disponible en PS5. Dead Space</title>
          ...
          <div class="game__content">
            ...
            <div class="game__right">
              <div class="game__image game__image_2">
                <picture>
                  <source media="(min-width: 320px)" srcset="./img/game/game-3-1.webp" type="image/webp">
                  <img src="./img/game/game-3-1.jpg" loading="lazy" width="300" height="300" alt="Image">
                </picture>
              </div>
              <div class="game__descr">
                <p class="game__text tx-1">
                  Dead Space es un juego de acción de ciencia ficción desarrollado por Visceral Games y publicado por Electronic Arts, que está muy bien valorado por los usuarios. El jugador juega como el reparador de equipos Isaac Clark, quien viaja a la estación espacial Ishimura para solucionar problemas de equipos.
                </p>
                <p class="game__text tx-1">
                  Sin embargo, rápidamente se entera de que la estación ha sido tomada por mutantes infectados conocidos como Necromorfos, que matan y convierten a los humanos en sus aliados. Isaac debe sobrevivir y resolver el misterio de las fuerzas siniestras que llevaron a esta tragedia.
                </p>
                <p class="game__text tx-1">
                  El juego es una combinación de supervivencia y terror. Tiene nuevas mecánicas únicas, como armas fabricadas con herramientas de ingeniería y la capacidad de reciclar cadáveres de necromorfos en recursos para mejorar armas y armaduras.
                </p>
                <p class="game__text tx-1">
                  Dead Space ha sido uno de los mejores juegos más icónicos de su género gracias a su atmósfera de terror, monstruos interesantes y una historia apasionante.
                </p>
              </div>
            </div>
          </div>
