...
<head>
  ...
  <meta property="og:title"
    content="Juego de acción con un mundo abierto y una nueva historia. Juego disponible en PS5. Elden Ring">
  ...
  <meta name="description"
    content="El juego ofrece gráficos mejorados y un tema musical pegadizo. El juego tendrá una mecánica de combate reelaborada y nuevas características con efectos especiales mejorados.">
  <title>Juego de acción con un mundo abierto y una nueva historia. Juego disponible en PS5. Elden Ring</title>
          ...
          <div class="game__content">
            ...
            <div class="game__right">
              <div class="game__image game__image_2">
                <picture>
                  <source media="(min-width: 320px)" srcset="./img/game/game-2-1.webp" type="image/webp">
                  <img src="./img/game/game-2-1.jpg" loading="lazy" width="300" height="300" alt="Image">
                </picture>
              </div>
              <div class="game__descr">
                <p class="game__text tx-1">
                  Elden Ring es un próximo nuevo juego de rol desarrollado en colaboración entre FromSoftware y el escritor George R.R. Martin. Los jugadores viajarán por el mundo abierto, explorarán diferentes lugares, lucharán contra enemigos y jefes y crearán un héroe personal. Este juego está inmerso en un oscuro mundo de fantasía lleno de misterios, criaturas misteriosas y oscuros secretos. Los jugadores pueden esperar un modo multijugador, las mejores tareas interesantes y difíciles, así como gráficos sorprendentes. Se espera que Elden Ring se lance en PlayStation, Xbox y PC en enero de 2022.
                </p>
              </div>
            </div>
          </div>
