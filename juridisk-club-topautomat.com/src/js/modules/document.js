...
const nomersContainer = document.querySelector(".nomers__container");

const nomersLink = document.querySelector(".nomers__link");

const galleryContainer = document.querySelector(".gallery__container_1");
...
if (nomersContainer) {
  ...
  if (document.body.clientWidth < 992) {
    nomersContainer.append(nomersLink);
  }
